...
- [ ] Ejemplo ejecutable para mobile (Flutter) — reintentado dos veces. La red de la sesión mejoró notablemente para otros hosts (python.org, pypi: hasta 24 MB/s), pero `storage.googleapis.com` (donde vive el SDK de Flutter) se mantuvo en ~100 KB/s ambas veces — parece un cuello de botella específico de ese host/CDN, no de la sesión. A ese ritmo faltaban más de dos horas; se abandonó de nuevo. Retomar solo si `storage.googleapis.com` responde más rápido, no basta con "mejor conexión en general".
