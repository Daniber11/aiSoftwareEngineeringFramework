...
| examples | Adopciones de referencia validables de punta a punta (cero dependencias, typescript-node y angular) | `examples/` | Pasa los validadores con `--root` | `examples/*/test/` (descubiertas por `node --test`) | Mantenedores |
