/**
 * Dominio de saludo: puro, sin Angular ni ningún otro framework.
 * Mismo patrón que examples/typescript-node-service y
 * examples/minimal-service, para que los tres ejemplos sean comparables.
 */
